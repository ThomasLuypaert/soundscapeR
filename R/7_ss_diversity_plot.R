    ...
    if (smooth == TRUE) {
      plot <-
        ...
        ggplot2::ylab(if (output == "percentage" & qvalue > 0) {
          ...
          if (output == "percentage" & qvalue == 0) {
            "Soundscape richness (%)\n"
          } else {
            if (output == "raw" & qvalue > 0) {
              "Soundscape diversity (# OSUs)\n"
            } else {
              if (output == "raw" & qvalue == 0) {
                "Soundscape richness (# OSUs)\n"
              } else {}
            }
          }
        }) +
        ...
        ggplot2::annotate(
          ...
          y = if (output == "percentage") {
            ...
            (max(total_tod$soundscape_div_smooth) + 7.5)
          },
          label = paste0(
            "q-value = ",
            qvalue
        ...
        plot <-
          ...
          ggplot2::annotate(
            ...
            y = if (output == "percentage") {
              ...
              (max(total_tod$soundscape_div) + 7.5)
            },
            label = paste0(
              "q-value = ",
              qvalue
    ...
    if (graphtype == "frequency") {
      ...
      if (graphtype == "normfreq") {
        ...
        if (smooth == TRUE) {
          ...
          plot <-
            ggplot2::ggplot(plot, ggplot2::aes(
              x = time_of_day,
              y = prop_sound_div,
              group = frequency,
              fill = frequency,
