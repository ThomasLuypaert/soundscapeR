  ...
  if (freqseq == "FALSE") {
      ...
      if (subset == "tod") {
        ...
        if (subset == "day") {
          ...
          if (subset == "night") {
            ...
            nighttime_df <- soundscape_obj@aggregated_df[
              rownames_subset,
              colnames_night
            ]
            ...
            if (subset == "dawn") {
              ...
              dawntime_df <- soundscape_obj@aggregated_df[
                rownames_subset,
                colnames_dawn
              ]
              ...
              if (subset == "dusk") {
                ...
                dusktime_df <- soundscape_obj@aggregated_df[
                  rownames_subset,
                  colnames_dusk
                ]
    ...
    if (freqseq == "TRUE") {
      ...
      if (subset == "total") {
        ...
        if (subset == "tod") {
          soundscape_diversity <- vector(
            "list",
            length(freq_list_2)
          )

          for (i in 1:length(freq_list_2)) {
            soundscape_diversity[[i]] <- vector(
              "list",
              ncol(freq_list_2[[i]])
            )
          ...
          if (subset == "day") {
            ...
            if (subset == "night") {
              ...
              for (i in 1:length(freq_list_2)) {
                freq_list_night[[i]] <- freq_list_2[[i]][
                  rownames_2[[i]],
                  colnames_night
                ]
              }
              ...
              for (i in 1:length(freq_list_night)) {
                if (identical(
                  rep(0, length(freq_list_night[[i]])),
                  freq_list_night[[i]]
                )) {
                  soundscape_diversity[[i]] <- 0
                } else {
              ...
              if (subset == "dawn") {
                ...
                for (i in 1:length(freq_list_2)) {
                  freq_list_dawn[[i]] <- freq_list_2[[i]][
                    rownames_2[[i]],
                    colnames_dawn
                  ]
                }
                ...
                if (subset == "dusk") {
                  ...
                  for (i in 1:length(freq_list_2)) {
                    freq_list_dusk[[i]] <- freq_list_2[[i]][
                      rownames_2[[i]],
                      colnames_dusk
                    ]
                  }
...
ss_evenness <- function(soundscape_obj = soundscape_obj,
                        ...
                        duskstart = 5400,
                        duskend = 0) {
  soundscape_richness <- soundscapeR::ss_diversity(
    soundscape_obj = soundscape_obj,
    qvalue = 0,
    subset = subset,
    mintime = mintime,
    maxtime = maxtime,
  ...
  soundscape_diversity <- soundscapeR::ss_diversity(
    soundscape_obj = soundscape_obj,
    qvalue = 2,
    subset = subset,
    mintime = mintime,
