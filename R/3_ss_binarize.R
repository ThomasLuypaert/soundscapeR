...
#' @export
#'
ss_threshold_check <- function(merged_soundscape,
                         method,
                         value = NULL){
  ...
  assertthat::on_failure(test_15) <- function(call, env){
    ...
    paste0(deparse(call$x), " is not a missing data frame. Did you supply a post-binarization or post-aggregation merged_soundscape to the ss_threshold_check() function? Please supply the output of the ss_index_merge() function to this argument.")
  ...
  assertthat::on_failure(test_16) <- function(call, env){
    ...
    paste0(deparse(call$x), " is not a list of NAs. Did you supply a post-binarization or post-aggregation merged_soundscape to the ss_threshold_check() function? Please supply the output of the ss_index_merge() function to this argument.")
