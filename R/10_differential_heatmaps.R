...
ss_compare <- function(aggregated_soundscape_A,
  ...
  assertthat::on_failure(test_13_A) <- function(call, env){
  ...
  assertthat::on_failure(test_13_B) <- function(call, env){
  ...
  assertthat::assert_that(test_13_A(aggregated_soundscape_A@merged_df))
  ...
  assertthat::assert_that(test_13_B(aggregated_soundscape_B@merged_df))
  ...
  if (type=="regular"){
    ...
    differential_soundscape_plot <-
          ...
          ggplot2::ggplot(differential_soundscape_matrix,
                        ggplot2::aes(x = time,
                                     y = frequency,
                                     fill = value,
                                     color = value)) +
    ...
    if (type=="polar"){
      ...
      else{print("You supplied an invalid 'type' argument, please choose one of: 'regular' or 'polar'")}
