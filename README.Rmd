...
As such, prior to using `soundscapeR`, please head over to the ['AnalysisPrograms' download page](https://ap.qut.ecoacoustics.info/basics/installing.html?tabs=windows), and check out the great work of this group! 
