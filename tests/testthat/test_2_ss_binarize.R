...
testthat::test_that("the ss_threshold function works for the 'IJDefault' binarization method if the correct CVR data frame is provided", {
  ...
  function_var <- try(ss_threshold(merged_soundscape = merged_soundscape_CVR@merged_df,
                                   method = "IJDefault"),
                      silent = TRUE)
...
testthat::test_that("the ss_threshold function works for the 'Mode' binarization method if the correct CVR data frame is provided", {
  ...
  function_var <- ss_threshold(merged_soundscape = merged_soundscape_CVR,
                               method = "Mode")
...
testthat::test_that("the ss_threshold function provides the correct error message when the supplied merged_soundscape argument is an empty data frame", {
  ...
  testthat::expect_error(
    object = ss_threshold(merged_soundscape = merged_df_CVR_empty,
                          method = "IJDefault"),
...
testthat::test_that("the ss_threshold function provides the correct error message when the supplied merged_soundscape argument is a data frame containing NA values", {
  ...
  testthat::expect_error(
    object = ss_threshold(merged_soundscape = merged_df_CVR_NAs,
                          method = "IJDefault"),
...
testthat::test_that("the ss_threshold function provides the correct error message when the supplied merged_soundscape argument is a data frame containing non-numeric values", {
  ...
  testthat::expect_error(
    object = ss_threshold(merged_soundscape = merged_df_CVR_nonnum,
                          method = "IJDefault"),
...
testthat::test_that("the ss_threshold function provides the correct error message when the supplied method argument is not one of the available options", {
  ...
  testthat::expect_error(
    object = ss_threshold(merged_soundscape = merged_soundscape_CVR,
...
testthat::test_that("the ss_binarize function works as expected when the correct arguments are supplied", {
 ...
 testthat::expect_equal(binarized_soundscape_CVR@threshold,
                        as.double(ss_threshold(merged_soundscape = merged_soundscape_CVR,
                                                method = "IsoData")))
...
testthat::test_that("The ss_threshold_check function works as expected when the correct arguments are supplied", {
  ...
  # 5.2. When the supplied merged_soundscape argument is wrong
    ...
    # 5.2.1. The merged_soundscape argument is not an S4 object of the type 'soundscape'
...
testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape output argument is not NA", {
  ...
  testthat::expect_error(
    ...
    # 5.3.9. The merged_merged_soundscape argument is wrong

testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape merged_merged_soundscape argument is empty", {
...
testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape merged_merged_soundscape argument contains NA values", {
...
testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape merged_merged_soundscape argument contains non-numeric values", {
...
testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape merged_merged_soundscape argument has incorrect row names", {

  testthat::expect_error(
    object = ss_threshold_check(merged_soundscape = merged_soundscape_merged_df4,
                         method = "IJDefault",
                         value=NULL),
    regexp = "merged_soundscape@merged_df does not have the correct row names. Please make sure the row names indicate the frequency values. This functions builds on the output of ss_index_merge(). Make sure you're supplying the merged_soundscape object produced by the ss_index_merge() function.",
    fixed=TRUE
  )

})

testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape merged_merged_soundscape argument has incorrect column names", {
...
testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape binarized_merged_soundscape argument is not missing", {
...
testthat::test_that("the ss_threshold_check function produces the correct error message when the merged_soundscape aggregated_merged_soundscape argument is not missing", {
