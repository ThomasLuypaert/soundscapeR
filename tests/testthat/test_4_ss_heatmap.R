...
testthat::test_that("the ss_heatmap function provides the correct error when the soundscape_obj argument is missing", {
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj argument is not an S4-object of the type 'soundscape' ", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR@merged_df),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj lat and lon argument don't match existing coordinates on Earth", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_coord_1),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_coord_2),
    regexp = "soundscape_obj@lat is not a valid coordinate. Did you supply the soundscape_obj produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_coord_3),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_coord_4),
    regexp = "soundscape_obj@lon is not a valid coordinate. Did you supply the soundscape_obj produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_coord_5),
    regexp = "soundscape_obj@lat is not a valid coordinate. Did you supply the soundscape_obj produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_coord_6),
    regexp = "soundscape_obj@lat is not a valid coordinate. Did you supply the soundscape_obj produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj tz argument is wrong", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_tz),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj index argument is wrong", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_index),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj samplerate argument is wrong", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_index_samplerate1),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj samplerate argument is wrong", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_index_samplerate2),
    regexp = "soundscape_obj@samplerate is not a single positive integer. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function, and pay special attention to the samplerate and window arguments.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj window argument is wrong", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_index_window1),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj window argument is wrong", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_index_window2),
    regexp = "soundscape_obj@window is not a single positive integer. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function, and pay special attention to the samplerate and window arguments.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj binarization method argument is wrong", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_binmeth),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj threshold argument is wrong", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_thresh),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj output argument is wrong", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_output),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the aggregate_soundscape merged_df argument is empty", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_df_1),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the aggregate_soundscape merged_df argument contains NA values", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_df_2),
    regexp = "soundscape_obj@merged_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the aggregate_soundscape merged_df argument contains non-numeric values", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_df_3),
    regexp = "soundscape_obj@merged_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the aggregate_soundscape merged_df argument has incorrect row names", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_df_4),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj binarized_df argument is empty", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_bindf1),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj binarized_df argument contains NA values", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_bindf2),
    regexp = "soundscape_obj@binarized_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj binarized_df argument contains non-numeric values", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_bindf3),
    regexp = "soundscape_obj@binarized_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj binarized_df argument has incorrect row names", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_bindf4),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj binarized_df argument is non-binary", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_bindf5),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj aggregated_df argument is empty", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_aggdf1),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj aggregated_df argument contains NA values", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_aggdf2),
    regexp = "soundscape_obj@aggregated_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj aggregated_df argument contains non-numeric values", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_aggdf3),
    regexp = "soundscape_obj@aggregated_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the soundscape_obj argument produced using the ss_aggregate() or ss_create() functions? If so, something has gone wrong, please re-run the ss_aggregate() or ss_create() function.",
    fixed=TRUE
  )
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj aggregated_df argument has incorrect row names", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_aggdf4),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj output argument is 'incidence_freq' but the data frame contains values larger than one.", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_aggdf6),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the soundscape_obj output argument is 'raw' but the data frame contains values larger than the number of sampling days", {

  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR_aggdf7),
...
testthat::test_that("the ss_heatmap function produces the correct error message when the type argument is not a character string", {
  ...
  testthat::expect_error(
    object = ss_heatmap(soundscape_obj = soundscape_obj_CVR,
                        type = 25),
