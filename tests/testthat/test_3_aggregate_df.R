...
# 2. Start testing the aggregate_df() function

  # 2.0. When some of the required arguments are missing

testthat::test_that("the aggregate_df function provides the correct error when the binarized_soundscape argument is missing", {

  testthat::expect_error(
    object = aggregate_df(output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function works as expected when the correct arguments are supplied", {
  ...
  testthat::expect_equal(as.character(aggregated_soundscape_CVR@first_day),"2015-09-05")
  testthat::expect_true(is.numeric(aggregated_soundscape_CVR@lat))
  testthat::expect_equal(aggregated_soundscape_CVR@lat,-1.915867928971629)
  testthat::expect_true(is.numeric(aggregated_soundscape_CVR@lon))
  testthat::expect_equal(aggregated_soundscape_CVR@lon,-59.48937990402315)
  ...
  testthat::expect_equal(aggregated_soundscape_CVR@binarization_method, "Otsu")
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape argument is not an S4-object of the type 'soundscape' ", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_CVR@merged_df,
                         output = "incidence_freq"),
    regexp = "binarized_soundscape is not an S4-object of the type 'soundscape'. Please supply the binarized_soundscape object produced by the binarize_df() function. Consult the package documentation for further information.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape lat and lon argument don't match existing coordinates on Earth", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_coord_1,
                          output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_coord_2,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@lat is not a valid coordinate. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_coord_3,
                          output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_coord_4,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@lon is not a valid coordinate. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_coord_5,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@lat is not a valid coordinate. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape lat and lon argument don't match existing coordinates on Earth", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_coord_6,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@lat is not a valid coordinate. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape tz argument is wrong", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_tz,
                          output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape index argument is wrong", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_index,
                          output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape samplerate argument is wrong", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_samplerate1,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@samplerate is not a single positive integer. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the samplerate and window arguments.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape samplerate argument is wrong", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_samplerate2,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@samplerate is not a single positive integer. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the samplerate and window arguments.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape window argument is wrong", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_window1,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@window is not a single positive integer. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the samplerate and window arguments.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape window argument is wrong", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_window2,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@window is not a single positive integer. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function, and pay special attention to the samplerate and window arguments.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape window argument is wrong", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_binmeth1,
                          output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape threshold argument is wrong", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_thresh1,
                          output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape output argument is not NA", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_output,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@output is not NA. Did you supply a post-binarization or post-aggregation soundscape to the check_thresh() function? Please supply the output of the merge_csv() function to this argument.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape merged_df argument is empty", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_merged_df1,
                         output = "incidence_freq"),
    regexp = "binarized_soundscape@merged_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function.",
    fixed=TRUE
  )

})

testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape merged_df argument contains NA values", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_merged_df2,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@merged_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape merged_df argument contains non-numeric values", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_merged_df3,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@merged_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape merged_df argument has incorrect row names", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_merged_df4,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@merged_df does not have the correct row names. Please make sure the row names indicate the frequency values. This functions builds on the output of binarize_df(). Make sure you're supplying the dataframe produced by the binarize_df() function.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape binarized_df argument is empty", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_bindf1,
                          output = "incidence_freq"),
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape binarized_df argument contains NA values", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_bindf2,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@binarized_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape binarized_df argument contains non-numeric values", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_bindf3,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@binarized_df is not a valid data frame. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply the binarized_soundscape argument produced using the binarize_df() function? If so, something has gone wrong, please re-run the binarize_df() function.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape binarized_df argument has incorrect row names", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_bindf4,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@binarized_df does not have the correct row names. Please make sure the row names indicate the frequency values. This functions builds on the output of binarize_df(). Make sure you're supplying the dataframe produced by the binarize_df() function.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape binarized_df argument is non-binary", {
  ...
  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_bindf6,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@binarized_df has values smaller than 0 or greater than 1. The function expects a binary data frame which is the output of the binarization step using the binarize_df() function.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape aggregated_df argument is not missing", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_missing,
                         output = "incidence_freq"),
    regexp = "binarized_soundscape@aggregated_df is not a missing data frame. Did you supply a post-aggregation soundscape to the binarized_soundscape argument of the binarize_df() function? Please supply the output of the binarize_df() function to this argument.",
    fixed=TRUE
  )

})

testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape aggregated_df_per_time argument is not a list of NAs", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_NA_list1,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@aggregated_df_per_time is not a list of NAs. Did you supply a post-aggregation soundscape to the binarized_soundscape argument of the binarize_df() function? Please supply the output of the binarize_df() function to this argument.",
    fixed=TRUE
  )

})

testthat::test_that("the aggregate_df function produces the correct error message when the binarized_soundscape effort_per_time argument is not a list of NAs", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_NA_list2,
                          output = "incidence_freq"),
    regexp = "binarized_soundscape@effort_per_time is not a list of NAs. Did you supply a post-aggregation soundscape to the binarized_soundscape argument of the binarize_df() function? Please supply the output of the binarize_df() function to this argument.",
    fixed=TRUE
  )
...
testthat::test_that("the aggregate_df function produces the correct error message when the supplied output argument is wrong", {

  testthat::expect_error(
    object = aggregate_df(binarized_soundscape = binarized_soundscape_CVR,
