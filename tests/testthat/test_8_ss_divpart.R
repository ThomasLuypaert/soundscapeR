...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument is missing", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(qvalue = 1),
    regexp = "soundscape_list argument is missing. Please supply the missing argument.",
    fixed = TRUE
  )
})

testthat::test_that("the ss_divpart function provides the correct error when the qvalue argument is missing", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument is not a list", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = c(2,3,4), qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument is not a list of S4 soundscape objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = wrong_list, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid coordinates", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_1, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid coordinates", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_2, qvalue = 1),
    regexp = "soundscape_list contains invalid latitude coordinates. Did you supply the a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_binarize() and ss_aggregate() functions, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid coordinates", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_3, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid coordinates", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_4, qvalue = 1),
    regexp = "soundscape_list contains invalid longitude coordinate. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_binarize() and ss_aggregate() functions, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid coordinates", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_5, qvalue = 1),
    regexp = "soundscape_list contains invalid latitude coordinates. Did you supply the a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_binarize() and ss_aggregate() functions, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid coordinates", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_6, qvalue = 1),
    regexp = "soundscape_list contains invalid latitude coordinates. Did you supply the a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_binarize() and ss_aggregate() functions, and pay special attention to the required coordinate format. Make sure you supply numerical decimal coordinates. Latitude values should range between -90 and 90. Longitude values should range between -180 and 180.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid timezones", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_tz, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid index objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_index, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid samplerate objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_samplerate1, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid samplerate objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_samplerate2, qvalue = 1),
    regexp = "soundscape_list contains samplerate arguments that are not a single positive integer. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_binarize() and ss_aggregate() functions, and pay special attention to the samplerate and window arguments.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid window objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_window1, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid window objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_window2, qvalue = 1),
    regexp = "soundscape_list contains window arguments that are not a single positive integer. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_binarize() and ss_aggregate() functions, and pay special attention to the samplerate and window arguments.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid binarization_method objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_bin, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid threshold objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_thresh, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid output objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_output, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid merged_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_outputdf_1, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid merged_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_outputdf_2, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid merged_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_outputdf_3, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid merged_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_outputdf_4, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid binarized_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_binarizeddf_1, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid binarized_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_binarizeddf_2, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid binarized_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_binarizeddf_3, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid binarized_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_binarizeddf_4, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df row names. Please make sure the row names indicate the frequency values. This functions builds on the output of ss_aggregate(). Make sure you're supplying the dataframe produced by the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid binarized_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_binarizeddf_5, qvalue = 1),
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid aggregated_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_aggdf_1, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid aggregated_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_aggdf_2, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid aggregated_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_aggdf_3, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df data frames. It is possible the argument is not a data frame, is empty, or contains NA/non-numeric values. Did you supply a list of soundscapes produced using the ss_aggregate() function? If so, something has gone wrong, please re-run the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function provides the correct error when the soundscape_list argument contains soundscape objects with invalid aggregated_df objects", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study_aggdf_4, qvalue = 1),
    regexp = "soundscape_list contains invalid merged_df, binarized_df, or aggregated_df row names. Please make sure the row names indicate the frequency values. This functions builds on the output of ss_aggregate(). Make sure you're supplying the dataframe produced by the ss_aggregate() function.",
    fixed = TRUE
  )
})
...
testthat::test_that("the ss_divpart function produces the correct error message when the qvalue argument is a character string", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
...
testthat::test_that("the ss_divpart function produces the correct error message when the qvalue argument is a list", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
...
testthat::test_that("the ss_divpart function produces the correct error message when the mintime argument does not follow the expected format", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the maxtime argument does not follow the expected format", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the mintime and maxtime arguments don't follow the expected format", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the minfreq argument is a negative number", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the minfreq argument is larger than the upper frequency bound", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the minfreq argument is not numeric", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the maxfreq argument is a negative number", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the maxfreq argument is larger than the upper frequency bound", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the maxfreq argument is not numeric", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the maxfreq argument is zero", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
testthat::test_that("the ss_divpart function produces the correct error message when the minfreq and maxfreq argument are not in the correct format", {
  testthat::expect_error(
    object = soundscapeR::ss_divpart(
      soundscape_list = soundscape_obj_CVR_case_study,
      qvalue = 0,
...
test_that("`ss_divpart()` works as expected when q = 0", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 0))
})

test_that("`ss_divpart()` works as expected when q = 1", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 1))
})

test_that("`ss_divpart()` works as expected when q = 2", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 2))
})
...
test_that("`ss_divpart()` works as expected when q = 0 and frequency subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 0,
                                          minfreq = 500,
                                          maxfreq = 2000))
...
test_that("`ss_divpart()` works as expected when q = 1 and frequency subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 1,
                                          minfreq = 500,
                                          maxfreq = 2000))
...
test_that("`ss_divpart()` works as expected when q = 2 and frequency subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 2,
                                          minfreq = 500,
                                          maxfreq = 2000))
...
test_that("`ss_divpart()` works as expected when q = 0 and temporal subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 0,
                                          mintime = "06:00:00",
                                          maxtime = "18:00:00"))
...
test_that("`ss_divpart()` works as expected when q = 1 and temporal subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 1,
                                          mintime = "06:00:00",
                                          maxtime = "18:00:00"))
...
test_that("`ss_divpart()` works as expected when q = 2 and temporal subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 2,
                                          mintime = "06:00:00",
                                          maxtime = "18:00:00"))
...
test_that("`ss_divpart()` works as expected when q = 0 and spectro-temporal subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 0,
                                          mintime = "06:00:00",
                                          maxtime = "18:00:00",
...
test_that("`ss_divpart()` works as expected when q = 1 and spectro-temporal subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 1,
                                          mintime = "06:00:00",
                                          maxtime = "18:00:00",
...
test_that("`ss_divpart()` works as expected when q = 2 and spectro-temporal subsetting", {
  expect_snapshot(soundscapeR::ss_divpart(soundscape_list = soundscape_obj_CVR_case_study,
                                          qvalue = 2,
                                          mintime = "06:00:00",
                                          maxtime = "18:00:00",
